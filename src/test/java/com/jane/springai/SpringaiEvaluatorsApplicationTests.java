package com.jane.springai;

import com.jane.springai.controller.ChatController;
...
class SpringaiEvaluatorsApplicationTests {
    ...
    private FactCheckingEvaluator factCheckingEvaluator; // Spring-managed evaluator

    private RelevancyEvaluator relevancyEvaluator;

    @Autowired
    public SpringaiEvaluatorsApplicationTests(ChatController chatController, FactCheckingEvaluator factCheckingEvaluator,
    ...
    @Value("${test.relevancy.min-score:0.55}")
